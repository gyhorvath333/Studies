		...
		<div id="loginbox" style="margin-top: 50px;"
			...
			<div class="panel panel-info">
				...
				<div class="panel-heading">
					<div class="panel-title">Bejelentkezés</div>
				</div>
			...
			<div>
				<a href="${pageContext.request.contextPath}/register/showRegistrationForm" class="btn btn-primary" role="button" aria-pressed="true">Új felhasználó</a>
			</div>
